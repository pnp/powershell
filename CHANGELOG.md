...
- Fix `-IsCopilotSearchable` parameter handling in `Add-PnPOrgAssetsLibrary` to prevent errors when using non-ImageDocumentLibrary types [#4852](https://github.com/pnp/powershell/issues/4852)
