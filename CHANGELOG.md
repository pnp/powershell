...
- Added `-OneDriveRequestFilesLinkEnabled` option to `Set-PnPTenant` to allow configuring the request files anonymously feature [#2360](https://github.com/pnp/powershell/pull/2360)
