...
### Changed
- Changed `Set-PnPListItem`, `Add-PnPListItem`, `Add-PnPFile` and `Copy-PnPFileMetadata` to retrieve only the fields named in `-Values` instead of the full field collection of the list. [#5437](https://github.com/pnp/powershell/pull/5437)
