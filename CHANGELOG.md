...
- Removed alias `Export-PnPClientSidePage`, please use `Export-PnPPage` cmdlet.
- Removed alias `Export-PnPClientSidePageMapping`, please use `Export-PnPPageMapping` cmdlet.
- Removed alias `Get-PnPClientSideComponent`, please use `Get-PnPPageComponent` cmdlet.
- Removed alias `Remove-PnPClientSideComponent`, please use `Remove-PnPPageComponent` cmdlet.
- Removed alias `Set-PnPClientSideText`, please use `Set-PnPPageTextPart` cmdlet.
- Removed alias `Set-PnPClientSideWebPart`, please use `Set-PnPPageWebPart` cmdlet.
