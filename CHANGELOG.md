...
- Added support for `Get-PnPSiteCollectionAppCatalog` and `Get-PnPTenantSite` to be used on vanity domain tenants [#3895](https://github.com/pnp/powershell/pull/3895)
