...
- Added `ImageUrl`, `PageImageAlignment`, `ImageHeight` and `ImageWidth` parameters to `Add-PnPPageTextPart` cmdlet so that users can add inline image in a Text webpart. [#2401](https://github.com/pnp/powershell/pull/2401)
