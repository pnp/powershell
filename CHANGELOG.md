...
- Added `-MakePrimarySiteCollectionAdmin` to `Add-PnPSiteCollectionAdmin` to allow for the primary site collection admin to be set [#2750](https://github.com/pnp/powershell/pull/2750)
