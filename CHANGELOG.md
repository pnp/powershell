...
### Fixed
- Fixed required Microsoft Graph permission metadata for `Send-PnPMail`, `Set-PnPList`, `Get-PnPWebAlert`, `Set-PnPSiteSensitivityLabel`, `Remove-PnPSiteSensitivityLabel`, and `Get-PnPAvailableSensitivityLabel`.
