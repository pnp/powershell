...
- Fixed missing Microsoft Graph permission metadata on `Set-PnPSiteClassification` and `Sync-PnPSharePointUserProfilesFromAzureActiveDirectory`, which call Microsoft Graph next to SharePoint CSOM but declared no permissions at all. [#5427](https://github.com/pnp/powershell/pull/5427)
