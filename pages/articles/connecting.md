...
```powershell
Connect-PnPOnline tenant.sharepoint.com -ClientId fa1a81f1-e729-44d8-bb71-0a0c339c0f62 -Tenant tenant.onmicrosoft.com -CertificatePath '.\PnPPowerShell.pfx' -CertificatePassword (ConvertTo-SecureString -AsPlainText -Force "password")
```
...
```PowerShell
Connect-PnPOnline tenant.sharepoint.com -ClientId fa1a81f1-e729-44d8-bb71-0a0c339c0f62 -Tenant tenant.onmicrosoft.com -Thumbprint $thumbprint
```
...
```PowerShell
Connect-PnPOnline tenant.sharepoint.com -ClientId fa1a81f1-e729-44d8-bb71-0a0c339c0f62 -Tenant tenant.onmicrosoft.com -CertificateBase64Encoded $encodedPfx
```
