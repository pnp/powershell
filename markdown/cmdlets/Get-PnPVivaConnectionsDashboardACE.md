...
## SYNOPSIS
Returns the Adaptive card extensions from the Viva connections dashboard page. This requires that you connect to a SharePoint Team site or Communication site and have configured the Viva connections page.
