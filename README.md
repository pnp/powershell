...
We have created a [guide](MIGRATE-3.0-to-4.0.md) for upgrading from previous versions to PnP PowerShell 4.x. If you are still using PowerShell 5.1 or the ISE, and want to use the latest major or nightly release, you will need to specify the required version like below: 
