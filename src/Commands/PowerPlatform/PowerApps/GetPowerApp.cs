    ...
    public class GetPowerApp : PnPAzureManagementApiCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            if (ParameterSpecified(nameof(Identity)))
            {
                ...
                var result = GraphHelper.GetAsync<Model.PowerPlatform.PowerApp.PowerApp>(this, Connection, $"{powerAppsUrl}/providers/Microsoft.PowerApps{(AsAdmin ? "/scopes/admin/environments/" + environmentName : "")}/apps/{appName}?api-version=2016-11-01", AccessToken).GetAwaiter().GetResult();
            ...
            else
            {
                ...
                var apps = GraphHelper.GetResultCollectionAsync<Model.PowerPlatform.PowerApp.PowerApp>(this, Connection, $"{powerAppsUrl}/providers/Microsoft.PowerApps/apps?api-version=2016-11-01&$filter=environment eq '{environmentName}'", AccessToken).GetAwaiter().GetResult();
