...
namespace PnP.PowerShell.Commands.Teams
{
    ...
    [RequiredApiDelegatedOrApplicationPermissions("graph/Group.ReadWrite.All", "graph/ChannelMember.ReadWrite.All")]
    [RequiredApiApplicationPermissions("graph/Group.ReadWrite.All", "graph/ChannelMember.ReadWrite.Group")]
    public class AddTeamsChannel : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            try
            {
                var channel = TeamsUtility.AddChannel(GraphRequestHelper, groupId, DisplayName, Description, ChannelType, OwnerUPN, false);
                WriteObject(channel);
            }
