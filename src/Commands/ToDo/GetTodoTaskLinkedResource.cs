...
{
    [Cmdlet(VerbsCommon.Get, "PnPTodoTaskLinkedResource")]
    ...
    public class GetTodoTaskLinkedResource : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            {
                var linkedResource = ToDoUtility.GetLinkedResource(GraphRequestHelper, url, listId, Task.Id, Identity);
                WriteObject(linkedResource, false);
            }
            else
            {
                var linkedResources = ToDoUtility.GetLinkedResources(GraphRequestHelper, url, listId, Task.Id);
                WriteObject(linkedResources, true);
            }
        }
    }
}
