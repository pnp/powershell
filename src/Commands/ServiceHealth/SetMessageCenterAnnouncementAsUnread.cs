...
{
    [Cmdlet(VerbsCommon.Set, "PnPMessageCenterAnnouncementAsUnread", DefaultParameterSetName = ParameterSet_ALL)]
    ...
    public class SetMessageCenterAnnouncementAsUnread : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            {
                WriteObject(ServiceHealthUtility.SetServiceUpdateMessageAsUnreadByIdAsync(Identities, HttpClient, AccessToken).GetAwaiter().GetResult(), true);
            }
            else
            {
