...
namespace PnP.PowerShell.Commands.ServiceHealth
{
    ...
    public class SetMessageCenterAnnouncementAsUnread : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            {
                WriteObject(ServiceHealthUtility.SetServiceUpdateMessageAsUnreadByIdAsync(this, Identity, Connection, AccessToken).GetAwaiter().GetResult(), true);
            }
            else
            {
                ...
                WriteObject(ServiceHealthUtility.SetServiceUpdateMessageAsUnreadByIdAsync(this, messageCenterAnnouncementIds, Connection, AccessToken).GetAwaiter().GetResult(), true);
            }
        }        
    }
}