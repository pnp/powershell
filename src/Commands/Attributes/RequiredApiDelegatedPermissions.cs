...
{
    /// <summary>
    /// Attribute to specify the required delegated permissions for calling into an API. Multiple attributes can be provided and are assumed as ORs towards eachother.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
    public sealed class RequiredApiDelegatedPermissions : RequiredApiPermissionsBase
    {
        /// <summary>
        ...
        public RequiredApiDelegatedPermissions(Enums.ResourceTypeName resourceType, string scope) : base(resourceType, scope)
        {            
        }
        ...
        public RequiredApiDelegatedPermissions(params string[] permissionScopes) : base(permissionScopes)
        {
        }        
    }
}
