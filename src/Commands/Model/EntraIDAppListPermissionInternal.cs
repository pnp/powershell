...
{
    /// <summary>
    /// Internal model for deserializing Graph API beta list/list-item permission responses.
    /// These APIs use <c>grantedToV2</c> (singular) rather than <c>grantedToIdentities</c> (array).
    /// </summary>
    internal class EntraIDAppListPermissionInternal
    {
        ...
        /// <summary>
        /// Used in the beta list/list-item permissions API response (singular object).
        /// </summary>
