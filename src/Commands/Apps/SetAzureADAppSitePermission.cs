    ...
    public class SetPnPAzureADAppSitePermission : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            if (siteId != Guid.Empty)
            {
                ...
                var results = PnP.PowerShell.Commands.Utilities.REST.RestHelper.PatchAsync<AzureADAppPermissionInternal>(HttpClient, $"https://{PnPConnection.CurrentConnection.GraphEndPoint}/v1.0/sites/{siteId}/permissions/{PermissionId}", AccessToken, payload).GetAwaiter().GetResult();
