...
namespace PnP.PowerShell.Commands.Apps
{
    ...
    public class GrantPnPEntraIDAppSitePermission : PnPGraphCmdlet
    {
        ...
        [Parameter(Mandatory = true)]
        [ArgumentCompleter(typeof(EnumAsStringArgumentCompleter<EntraIDNewSitePermissionRole>))]
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            if (siteId != Guid.Empty)
            {
                ...
                var results = Utilities.REST.RestHelper.PostAsync<AppPermissionInternal>(Connection.HttpClient, $"https://{Connection.GraphEndPoint}/v1.0/sites/{siteId}/permissions", AccessToken, payload).GetAwaiter().GetResult();
