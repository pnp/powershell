    ...
    public class RevokeTenantServicePrincipal : PnPGraphCmdlet
    {
        ...
        protected override void ExecuteCmdlet()
        {
            ...
            using (var tenantContext = ClientContext.Clone(tenantUrl))
            {
                ...
                var results = GraphHelper.GetAsync<RestResultCollection<ServicePrincipal>>(this, Connection, $"/v1.0/servicePrincipals?$filter=appId eq '{appId}'&$select=id", AccessToken).GetAwaiter().GetResult();
