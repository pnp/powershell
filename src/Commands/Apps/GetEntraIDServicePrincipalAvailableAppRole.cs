...
{
    [Cmdlet(VerbsCommon.Get, "PnPEntraIDServicePrincipalAvailableAppRole")]
    [RequiredMinimalApiPermissions("Application.Read.All")]
    [OutputType(typeof(List<ServicePrincipalAppRole>))]
    [Alias("Get-PnPAzureADServicePrincipalAvailableAppRole")]
    public class GetEntraIDServicePrincipalAvailableAppRole : PnPGraphCmdlet
    {
