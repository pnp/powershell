...
namespace PnP.PowerShell.Commands.Microsoft365Groups
{
    ...
    public class GetMicrosoft365GroupMember : PnPGraphCmdlet
    {
        ...
        {
            var members = Microsoft365GroupsUtility.GetMembersAsync(this, Connection, Identity.GetGroupId(this, Connection, AccessToken), AccessToken).GetAwaiter().GetResult();
