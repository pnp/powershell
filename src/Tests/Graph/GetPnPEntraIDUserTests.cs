...
{
    [TestClass]
    public class GetEntraIDUserTests
    {
        ...
        public void GetPnPAADUserTest()
        {
            using (var scope = new PSTestScope(true))
            {
				...
				var delta = "";
				// From Cmdlet Help: The change token provided during the previous run with -Delta to query for the changes to user objects made in Entra ID since that run
				var deltaToken = "";
