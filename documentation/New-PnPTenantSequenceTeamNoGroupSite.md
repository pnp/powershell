...
HelpUri: https://pnp.github.io/powershell/cmdlets/New-PnPTenantSequenceTeamNoGroupSite.html
...
```
New-PnPTenantSequenceTeamNoGroupSite -Url <String> -Title <String> -TimeZoneId <UInt32>
 [-Language <UInt32>] [-Owner <String>] [-Description <String>] [-HubSite] [-TemplateIds <String[]>]
```
