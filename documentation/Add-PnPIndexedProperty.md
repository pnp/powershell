...
HelpUri: https://pnp.github.io/powershell/cmdlets/Add-PnPIndexedProperty.html
...
```
Add-PnPIndexedProperty [-Key] <String> [-List <ListPipeBind>] [-Connection <PnPConnection>]
```
