...
HelpUri: https://pnp.github.io/powershell/cmdlets/Remove-PnPListItemVersion.html
...
```
Remove-PnPListItemVersion -List <ListPipeBind> -Identity <ListItemPipeBind>
 -Version <ListItemVersionPipeBind> [-Force] [-Verbose] [-Connection <PnPConnection>]
 [<CommonParameters>]
```
