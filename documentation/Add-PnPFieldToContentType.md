...
HelpUri: https://pnp.github.io/powershell/cmdlets/Add-PnPFieldToContentType.html
...
```
Add-PnPFieldToContentType -Field <FieldPipeBind> -ContentType <ContentTypePipeBind> [-Required]
 [-Hidden] [-Connection <PnPConnection>]
```
