...
HelpUri: https://pnp.github.io/powershell/cmdlets/Set-PnPWebPartProperty.html
...
```
Set-PnPWebPartProperty -ServerRelativePageUrl <String> -Identity <Guid> -Key <String>
 -Value <PSObject> [-Connection <PnPConnection>]
```
