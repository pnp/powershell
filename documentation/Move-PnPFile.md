...
HelpUri: https://pnp.github.io/powershell/cmdlets/Move-PnPFile.html
...
```
Move-PnPFile [-SourceUrl] <String> [-TargetUrl] <String> [-Overwrite] [-AllowSchemaMismatch]
 [-AllowSmallerVersionLimitOnDestination] [-IgnoreVersionHistory] [-NoWait] [-Force]
