...
```powershell
Get-PnPUnsuccesfulCrawledUrls [-Filter <String>]  [-StartDate <DateTime>] [-EndDate <DateTime>] [-RawFormat]
...
### EXAMPLE 2
```powershell
Get-PnPUnsuccesfulCrawledUrls -Filter "https://contoso-my.sharepoint.com/sites/Intranet"
```
...
### EXAMPLE 3
```powershell
Get-PnPUnsuccesfulCrawledUrls -StartDate (Get-Date).AddDays(-10)
```
...
Get-PnPUnsuccesfulCrawledUrls -Filter "https://contoso-my.sharepoint.com/sites/Intranet" -IncreaseRequestTimeout
```
...
Get-PnPUnsuccesfulCrawledUrls -Filter $scope
```
