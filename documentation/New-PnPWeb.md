...
HelpUri: https://pnp.github.io/powershell/cmdlets/New-PnPWeb.html
...
```
New-PnPWeb -Title <String> -Url <String> -Template <String> [-Description <String>]
 [-Locale <Int32>] [-BreakInheritance] [-InheritNavigation] [-Connection <PnPConnection>]
```
