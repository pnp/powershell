...
### Example 1
```powershell
Remove-PnPPlannerBucket -Group "Marketing" -Plan "Conference" -Identity "Pre-conference Todo's"
```

This removes the "Pre-conference Todo's" bucket from the specified plan.
