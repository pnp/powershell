...
online version: https://pnp.github.io/powershell/cmdlets/remove-pnppublishingimagerendition
schema: 2.0.0
...
```powershell
Remove-PnPPublishingImageRendition [-Identity] <ImageRenditionPipeBind> [-Force] [-Web <WebPipeBind>]
