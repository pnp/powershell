...
HelpUri: https://pnp.github.io/powershell/cmdlets/Add-PnPWebPartToWikiPage.html
...
```
Add-PnPWebPartToWikiPage -ServerRelativePageUrl <String> -Xml <String> -Row <Int32> -Column <Int32>
