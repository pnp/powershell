...
## SYNOPSIS
Add an Adaptive card extension in the Viva connections dashboard page. This requires that you connect to a SharePoint Team or Communication site and have configured the Viva connections page.
...
Allows to add a new an Adaptive card extension in the Viva Home dashboard page. Before running the command it is required you are connected to a SharePoint Team or Communication site and have configured the Viva connections page. 
