...
online version: https://pnp.github.io/powershell/cmdlets/test-pnplistitemisrecord
schema: 2.0.0
...
```powershell
Test-PnPListItemIsRecord [-List] <ListPipeBind> -Identity <ListItemPipeBind> [-Web <WebPipeBind>]
