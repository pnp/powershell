...
## DESCRIPTION
This command returns the libraries to which a Microsoft Syntex content understanding model defined in the connected Microsoft Syntex Content Center site was published.
