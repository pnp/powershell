...
HelpUri: https://pnp.github.io/powershell/cmdlets/Add-PnPView.html
...
```
Add-PnPView [-List] <ListPipeBind> -Title <String> -Fields <String[]> [-Query <String>]
 [-ViewType <ViewType>] [-RowLimit <UInt32>] [-Personal] [-SetAsDefault] [-Paged]
