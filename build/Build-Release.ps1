...
$availableVersions = Find-Module -Name PnP.PowerShell | Select-Object -First 1
...
& "$PSScriptRoot/../build/Generate-PredictorCommands.ps1" -Version $version
...
Publish-Module -Name PnP.PowerShell -NuGetApiKey $apiKey
